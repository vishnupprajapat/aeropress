            ...
            <div className="container">
                ...
                <div className="center-recipe-tab">
                    <ul>
                        ...
                        <li className="" data-attr-tag="Hot">
                            <div className="svg-recipe">
                                <svg
                                    width={20}
                                    height={21}
                        ...
                        <li className="" data-attr-tag="Cold">
                            <div className="svg-recipe">
                                <svg
                                    width={20}
                                    height={21}
                        ...
                        <li className="" data-attr-tag="Popular">
                            <div className="svg-recipe">
                                <svg
                                    width={20}
                                    height={21}
                        ...
                        <li className="" data-attr-tag="See All">
                            <div className="svg-recipe">
                                <svg
                                    width={21}
                                    height={22}
